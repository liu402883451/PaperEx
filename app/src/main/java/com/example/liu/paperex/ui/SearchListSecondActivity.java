...
public class SearchListSecondActivity extends AppCompatActivity {
    ...
    private void assignViews() {
        ...
        mPullGv = (PullToRefreshGridView) findViewById(R.id.list_gl_mostnew);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_list_second);
        ...
        mPullGv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent intent = new Intent(SearchListSecondActivity.this, BigPicActivity.class);
            ...
            public void onPullDownToRefresh(PullToRefreshBase<GridView> refreshView) {
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (page == 0) {
                            Toast.makeText(SearchListSecondActivity.this, "没有更多图片了", Toast.LENGTH_SHORT).show();
                        }else{
